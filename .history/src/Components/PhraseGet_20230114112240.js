...
function PhraseGet() {
	...
	function handleChangeCategory(e) {
		...
		let previousIdList =
			JSON.parse(localStorage.getItem(`previousid${e.target.value}`)) ||
			[];
	// filter the id list to exclude the previous numbers
	const filteredIdList = idLists[selectedCategoryId].filter(number => !previousIdList.includes(number));
